                ...
                <div className={toggleState === 1 ? "services_modal active_modal" : "services_modal"}>
                    <div className="services_modal-content">
                        ...
                        <ul className="services_modal-services grid">
                            <li className="services_modal-sevice">
                            ...
                            <li className="services_modal-sevice">
                                <i className="uil uil-check-circle services_modal-icon"></i>
                                <p className="services_modal-info">Design and mochups of products for companies.</p>
                            </li>

                            <li className="services_modal-sevice">
                                <i className="uil uil-check-circle services_modal-icon"></i>
                                <p className="services_modal-info">I create UX element interaction</p>
                            </li>
                        </ul>
                    </div>
                </div>
