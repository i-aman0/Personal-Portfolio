...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_cgelb53', 'template_x17fr7e', form.current, 'aQsBBi2uznnIq9yn_')
          e.target.reset();
      };
            ...
            <div className="contact_content">
                ...
                <div className="contact.info">
                    <div className="contact_card">
                        ...
                        <a href="mailto:khan.aman902688@gmail.com" className="contact_button">Write Me <i className="bx bx-right-arrow-alt contact_button-icon"></i></a>
                    </div>
                    ...
                    <div className="contact_card">
                        ...
                        <span className="contact_card-data">9026886373</span>

                        <a href="https://api.whatsapp.com/send?phone=9026886373&text=Hello, more information!" className="contact_button">Write Me <i className="bx bx-right-arrow-alt contact_button-icon"></i></a>
                    </div>
                    ...
                    <div className="contact_card">
                        ...
                        <span className="contact_card-data">starlord_aman</span>

                        <a href="https://instagram/starlord_aman" className="contact_button">Write Me <i className="bx bx-right-arrow-alt contact_button-icon"></i></a>
                    </div>
                </div>
            </div>
